...
<div class="btn-group btn-corner">
    <a href="<?=HOME_URI.$this->controller?>/adicionar-local-de-estoque" class="btn btn-success btn-sm filterRegistry filterRegistry"><i class="fa fa-plus bigger-110 "></i> Novo</a>
    ...
    <a href="#modal-confirm" data-toggle="modal" data-table="wd_local_de_estoque" class="btn btn-danger  btn-sm  delete "><i class="fa fa-trash-o "></i> Excluir selecionados</a>
</div>
</div>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
      ...
      <tbody>
          ...
          <?
          $_attributes = $model->getList('localdeestoque');
          ...
          <tr role="row" class="odd">
			  ...
			  <td align="center"><a href="<?=HOME_URI.$this->controller."/editar-local-de-estoque/".$_item[ID]?>"><button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button></a></td>
		  </tr>              
          <?
          endforeach;
          ?>
