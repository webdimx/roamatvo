...
<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
	...
	<div class="dt-buttons btn-overlap btn-group">
		<div class="btn-group btn-corner">
			<a href="<?= HOME_URI . $this->controller ?>/adicionar-local-de-estoque"
			...
			<a href="#" class="btn btn-primary btn-sm filterRegistry filterRegistry"><i class="fa fa-search bigger-110 "></i>
				Filtrar</a>
			<a href="<?= HOME_URI . $this->controller . $this->subController ?>" class="btn btn-primary btn-sm  clear-filters"><i
			...
			<a href="#modal-confirm" data-toggle="modal" data-table="wd_local_de_estoque"
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid"
		...
		<thead>
			<tr role="row">
				...
				<th rowspan="1" colspan="1">Local<br><input type="text" class="filter" name="local" value="<?= $_GET['local'] ?>">
				</th>
		...
		<tbody>
			...
			foreach ($_attributes[data] as $_item):
				...
				<tr role="row" class="odd">
					...
					<td align="center"><a href="<?= HOME_URI . $this->controller . "/editar-local-de-estoque/" . $_item[ID] ?>"><button
