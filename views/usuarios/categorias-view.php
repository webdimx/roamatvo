...
<div class="widget-box  ui-sortable-handle page-box" id="usuarios" style="opacity: 1;">
    <div class="widget-header widget-header-small">
        <h6 class="widget-title">Categorias Usuários</h6>
    </div>
    ...
    <div class="widget-body">
        <div class="widget-main padding-20 scrollable " data-size="125" style="position: relative;">
            ...
            <div class="row">
              <div class="col-xs-12">
              	 <div class="well fake-form">
                 	<div class="row">
                    	<div class="col-xs-12">
                    		<h4 class="blue smaller ">Adicione uma categoria</h4>
                    	</div>
                    </div>
                    ...
                    <div class="row">
                    	<div class="col-xs-12">
                            ...
                            <button type="button" class="btn btn-sm btn-success action-add" data-action="add-category">Adicionar</button>
                        </div>
                    </div>
            ...
            <tbody>
             <?
			 $categorias = $model->_getCategories('usuarios');
             if($categorias):
			 	foreach($categorias as $categoria):
				?>
                <tr>
                  <td rowspan="1" colspan="1"><?=$categoria[nome]?></td>
                  <td rowspan="1" colspan="1">
                  	<a class="btn btn-xs btn-info note-edit" data-id="<?=$categoria[ID]?>">
                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                    </a>
                    <a class="btn btn-xs btn-danger note-del"  data-id="<?=$categoria[ID]?>">
