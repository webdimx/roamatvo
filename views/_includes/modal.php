				...
				<div class="modal-body row">
						...
						<div class="profile-user-info profile-user-info-striped">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="iccid" name="filter[]"><span
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="fornecedor_simcard"
											name="filter[]"><span class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="mdn" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>MDN</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="fornecedor_mdn" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="plano" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>PLANO</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="tipo" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>TIPO</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="emitir_nota" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>NF</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="data_transacao" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="data_ativacao" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="data_off" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>DATA OFF</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="adiar" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="atendente" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>ATENDENTE</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="local_venda" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="ponto_venda" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
					...
					<div class="col-lg-6" style="padding: 0">
						<div class="profile-user-info profile-user-info-striped">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="nome" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="celular" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>CELULAR</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="email" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>E-MAIL</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="documento" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>DOCUMENTO</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="local_uso" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="dias_uso" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="valor_plano" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="forma_pagamento"
											name="filter[]"><span class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="moeda" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>MOEDA</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="desconto" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>DESCONTO</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="valor_pago" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="aparelho" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
									<span>APARELHO</span>
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="paises" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
							...
							<div class="profile-info-row">
								<div class="profile-info-name" style="width: 25px">
									<label class="pos-rel"><input type="checkbox" class="ace" value="observacao" name="filter[]"><span
											class="lbl"></span></label>
								</div>
								<div class="profile-info-value">
		...
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
				...
				<p>
					...
					<input type="text" class="date-range col-xs-12" data-date-format="dd/mm/yyyy" name="periodo"
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<form class="importer">
						<div class="col-xs-12 ">
							...
							<div class="form-group">
								<label class="ace-file-input ace-file-multiple"><input multiple="" type="file" id="id-input-file-3"
										name="lote"><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label>
							</div>
						</div>
					...
					<div class="col-lg-12 tableImport ">
						...
						<div class="text-center"><img src="<?= HOME_URI ?>views/assets/images/wait.gif" alt=""
								class="ajaxLoader hidden"></div>
				...
				<div class="row">
					<div class="col-lg-12 text-center"><img src="<?= HOME_URI ?>views/assets/images/wait.gif" alt=""
							class="ajaxLoader" hidden></div>
				</div>
			</div>
			...
			<div class="modal-footer">
				...
				<a href="" class="model"><button class="btn btn-warning btn-sm " data-rel="tooltip" data-placement="bottom"
						title="Baixar Modelo de Planilha"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button></a>
						...
						<div class="col-xs-12 ">
							...
							<div class="form-group">
								<label class="ace-file-input ace-file-multiple">
									<input multiple="" type="file" id="id-input-file-7" name="lote"><a class="remove" href="#"><i
				...
				<div class="row">
					<form class="importerSend">
						<div class="col-xs-12 ">
							...
							<div class="form-group">
								<label class="ace-file-input ace-file-multiple"><input multiple="" type="file" id="id-input-file-5"
										name="lote"><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<div class="swapFeed pull-left">
					<p><label class="pos-rel swapT"><input type="checkbox" name="adiar" class="ace gswap" value="1"
								data-tipo="1"><span class="lbl"></span> Exibir Swaps do dia seguinte</label></p>
					<p class="text-left"><label class="pos-rel"><input type="checkbox" name="OnlySelected" class="ace gswap"
								value="1" data-tipo="1"><span class="lbl"></span> Somente os Selecionados</label></p>
				</div>
