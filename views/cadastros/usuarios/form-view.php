            ...
            <div class="content">
			  ...
			  <div class="col-lg-6 ">
                <p>
                  ...
                  <input type="text"  name="<?=$this->controller?>[valor]"  class="col-xs-12 col-sm-12 col-lg-12 required money "  value="<?=money($data[valor])?>">
                </p>
              </div>
			  ...
			  <div class="col-lg-12">
                <p>
                  ...
                  <input type="text"  name="<?=$this->controller?>[observacao]"  class="col-xs-12 col-sm-12 col-lg-12 required"  value="<?=$data[observacao]?>">
                </p>
              </div>
