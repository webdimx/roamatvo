				...
				<div class="row">
					...
					<div class="col-lg-5ths ">
						<p>
							...
							<input type="text" name="<?= $this->controller ?>[mdn]" class="col-xs-12 col-sm-12 col-lg-12   required"
								value="<?= $data[mdn] ?>">
						</p>
					</div>
					...
					<div class="col-lg-3 ">
						<p>
							...
							<select name="<?= $this->controller ?>[local_uso]" id="plano"
								class="col-xs-12 col-sm-12 col-lg-12 required">
								<option value="">Selecione</option>
								<?
					...
					<div class="col-lg-3 ">
						<p>
							...
							<input type="text" name="<?= $this->controller ?>[valor_plano]"
								class="col-xs-12 col-sm-12 col-lg-12 moneyUSD required" readonly value="<?= $data[valor_plano] ?>">
						</p>
					</div>
					...
					<div class="col-lg-3 ">
						<p>
							...
							<select name="<?= $this->controller ?>[forma_pagamento]" id="fp"
								class="col-xs-12 col-sm-12 col-lg-12 required <?= ($data[forma_pagamento] ? 'disabled' : '') ?>">
	...
	$(document).ready(function () {
		...
		$('#plano').change(function () {
			...
			$.post(ajaxUrl + 'cadastros/getPlano', { ID: $(this).val() }, function (a) {
				...
				$("[name='transacoes[local_uso]']").val(a.plano.local_uso).addClass('disabled')
