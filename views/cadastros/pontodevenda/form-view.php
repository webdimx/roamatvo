            ...
            <div class="content">
              ...
              <div class="col-lg-6 ">
                <p>
                  ...
                  <input type="text"  name="<?=$this->controller?>[ponto]"  class="col-xs-12 col-sm-12 col-lg-12 required"  value="<?=$data[ponto]?>">
                </p>
              </div>
                ...
                <p>
				 <label class="control-label no-padding-right" for="form-field-1">Local de Venda:</label><br>
                  <select  name="<?=$this->controller?>[local]"  class="col-xs-12 col-sm-12 col-lg-12 required">
					...
					?>
					<option value="<?=$option[ID]?>" <?=($option[ID]==$data[local]?'selected':'') ?> > <?=$option[local]?></option>
					<?
					 endforeach;
					?>
			  </select>
