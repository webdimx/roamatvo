...
<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
	...
	<div class="dt-buttons btn-overlap btn-group">
		<div class="btn-group btn-corner">
			<a href="<?= HOME_URI . $this->controller ?>/adicionar-pais"
			...
			<a href="#modal-confirm" data-toggle="modal" data-table="wd_paises" class="btn btn-danger  btn-sm  delete "><i
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid"
		...
		<thead>
			<tr role="row">
				...
				<th rowspan="1" colspan="1">Nome<br><input type="text" class="filter" name="nome" value="<?= $_GET['nome'] ?>">
				</th>
		...
		<tbody>
			...
			<?
			$_attributes = $model->getList('paises');
			...
			foreach ($_attributes[data] as $_item):
				...
				<tr role="row" class="odd">
					...
					<td align="center"><a href="<?= HOME_URI . $this->controller . "/editar-pais/" . $_item[ID] ?>"><button
