...
<div class="btn-group btn-corner">
    <a href="<?=HOME_URI.$this->controller?>/adicionar-formas-de-pagamento" class="btn btn-success btn-sm filterRegistry filterRegistry"><i class="fa fa-plus bigger-110 "></i> Novo</a>
    ...
    <a href="#modal-confirm" data-toggle="modal" data-table="wd_formas_pagamento" class="btn btn-danger  btn-sm  delete "><i class="fa fa-trash-o "></i> Excluir selecionados</a>
</div>
</div>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
      <thead>
          ...
          <th rowspan="1" colspan="1">Sigla<br><input type="text" class="filter" name="sigla" value="<?=$_GET['sigla']?>"></th>
          <th rowspan="1" colspan="1">Situacao<br>
			 <select name="a|situacao" class="filter">
				<option value=""></option>
				<option value="1" <?=($_GET["a|situacao"]==1?'checked':'')?>>Ativo</option>
				<option value="2" <?=($_GET["a|situacao"]==2?'checked':'')?>>Inativo</option>
			</select>  	  
		  </th>
      ...
      <tbody>
          ...
          <?
          $_attributes = $model->getList('formasdepagamento');
          ...
          <tr role="row" class="odd">
			  ...
			  <td><?=($_item[situacao]==1?'Ativo':'Inativo')?></td>
               <td align="center"><a href="<?=HOME_URI.$this->controller."/editar-formas-de-pagamento/".$_item[ID]?>"><button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button></a></td>
		  </tr>
		  <?
          endforeach;
          ?>
