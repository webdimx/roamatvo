 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
	...
	$ConsTotal = mysql_query($_pagi_sql);
	$TotaTotal = mysql_num_rows($ConsTotal);
	...
	//	die (" Error en la consulta de conteo de registros: $_pagi_sqlConta. Mysql dijo: <b>".mysql_error()."</b>");
 	//}
 	$_pagi_totalReg = $TotaTotal;//total de registros
 }else{
 ...
 */
 ...
 // Añadimos el query string a la url.
  $_pagi_enlace = str_replace("&", "/", $_pagi_enlace = str_replace(array('p=','/index.php'),"",$_pagi_enlace .= $_pagi_query_string));
 ...
 */
 ...
 /*if ($_pagi_actual != 1){
	...
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."' class='previous'>Anterior</a>";
 }else{
	 $_pagi_navegacion_temporal[] = "<SPAN class='previousNextDisabled'>Anterior</SPAN>";	 
 }*/
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	if ($_pagi_i == $_pagi_actual) {
		...
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." class='PS' href='".$_pagi_i."' >".$_pagi_i."</a>";
	}else{
		// Si es cualquier otro. Se escibe el enlace a dicho número de página.
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod."  href='".$_pagi_i."'>".$_pagi_i."</a>";
	}
 }
 ...
 /*if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."' class='next'>Seguinte</a>";
	...
	$_pagi_navegacion_temporal[] = "<SPAN class='previousNextDisabled'>Seguinte</SPAN>";
 ...
 */
 ...
 $_pagi_info = "Registro $_pagi_desde até $_pagi_hasta de $_pagi_totalReg";
