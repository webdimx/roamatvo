...
<div class="btn-group btn-corner">
    <a href="<?=HOME_URI.$this->controller?>/adicionar-atendente" class="btn btn-success btn-sm filterRegistry filterRegistry"><i class="fa fa-plus bigger-110 "></i> Novo</a>
    ...
    <a href="#modal-confirm" data-toggle="modal" data-table="wd_atendentes" class="btn btn-danger  btn-sm  delete "><i class="fa fa-trash-o "></i> Excluir selecionados</a>
</div>
</div>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
      <thead>
		  ...
		  <th rowspan="1" width="200" colspan="1">Local de Atuação<br>
			 <select name="area_atuacao" class="filter">
				<option value=""></option>
				<option value="1" <?=($_GET[area_atuacao]==1?'checked':'')?>>AERO</option>
				<option value="2" <?=($_GET[area_atuacao]==2?'checked':'')?>>HD</option>
			</select>  	  
		  </th>
      ...
      <tbody>
          ...
          <?
          $_attributes = $model->getList('atendentes');
          ...
          <tr role="row" class="odd">
              ...
              <td><?=$_item[nome]?></td>
			  <td><?=($_item[area_atuacao]==1?'AERO':($_item[area_atuacao]==2?'HD':''))?></td>
			  ...
			  <td align="center"><a href="<?=HOME_URI.$this->controller."/editar-atendente/".$_item[ID]?>"><button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button></a></td>
		  </tr>
