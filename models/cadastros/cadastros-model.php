...
class CadastrosModel extends MainController
{
	...
	public function _submit($table, $lote){
		...
		$query = $this->db->update($this->tablePlanos, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tablePlanos, array(
		...
		$query = $this->db->update($this->tableFornecedores, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableFornecedores, array(
		...
		$query = $this->db->update($this->tableAtendentes, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableAtendentes, array(
		...
		$query = $this->db->update($this->tableLocalVenda, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableLocalVenda, array(
		...
		$query = $this->db->update($this->tablePontoVenda, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tablePontoVenda, array(
		...
		$query = $this->db->update($this->tableLocalUso, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableLocalUso, array(
		...
		$query = $this->db->update($this->tableLocalEstoque, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableLocalEstoque, array(
		...
		$query = $this->db->update($this->tableFormasPagamento, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableFormasPagamento, array(
		...
		$query = $this->db->update($this->tableMoedas, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableMoedas, array(
		...
		$query = $this->db->update($this->tableStatusMDN, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableStatusMDN, array(
		...
		$query = $this->db->update($this->tableStatusSimcard, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableStatusSimcard, array(
		...
		$query = $this->db->update($this->tableTipoUso, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableTipoUso, array(
	...
	if($table=='mdn'):
		...
		$query = $this->db->update($this->tableMdn, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		$query = $this->db->insert($this->tableMdn, array(
		...
		$query = $this->db->update($this->tableSimcard, 'ID', chk_array( $this->form_data, 'ID'), array(
		...
		if(chk_array( $this->form_data, 'status_simcard')==1):
			...
			if($d[id_associacao]):
			$query = $this->db->update($this->tableMdn, 'ID', $d[id_associacao], array(
		...
		$query = $this->db->insert($this->tableSimcard, array(
	...
	public function getList($table) {
		...
		$page = isset($_GET['p']) ? ((int) $_GET['p']) : 1; unset($_GET[path], $_GET[p]);
	...
	public function _addCategory(){
		...
		$query = $this->db->insert($this->tableCategory, array(
	...
	public function _addSubject(){
		...
		$query = $this->db->insert('wd_agendamento_pauta', array(
	...
	public function _addRoom(){
		...
		$query = $this->db->insert($this->tableRoom, array(
	...
	public function _addModalidade(){
		...
		$query = $this->db->insert($this->tableModalidades, array(
	...
	public function _addNivel(){
		...
		$query = $this->db->insert($this->tableNivel, array(
	...
	public function _addCustomFields(){
		...
		$query = $this->db->insert($this->tableFields, array(
	...
	function sendToLocal($data){
		...
		$query = $this->db->insert($this->tableEnvios, array(
		...
		foreach($data as $item){
			...
			$query = $this->db->update($this->tableSimcard, 'simcard', $item[A], array(
	...
	public function changeStatus($item, $status){
		...
		$query = $this->db->update($this->tableMdn, 'mdn', $item, array(
