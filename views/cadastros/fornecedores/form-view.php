    ...
    <div class="widget-body">
        <div class="widget-main padding-20 scrollable " data-size="125" style="position: relative;">
			...
			<div class="col-lg-6">
			 ...
			 <div class="col-lg-6 ">
                <p>
                  <label class="control-label no-padding-right" for="form-field-1">Tipo Transação:</label><br>
			  ...
			  <div class="col-lg-6 ">
                <p>
                  <label class="control-label no-padding-right" for="form-field-1">Exibir nas Transações:</label><br>
					
				  <select name="<?=$this->controller?>[exibir_transacao]"  class="col-xs-12 col-sm-12 col-lg-12  ">
					 
					 <option value="1" <?=($data[exibir_transacao]==1?'selected':'')?>>Não</option>
					 <option value="2" <?=($data[exibir_transacao]==2?'selected':'')?>>Sim</option>
              ...
              <div class="col-lg-6 ">
                <p>
                  ...
                  <input type="text"  name="<?=$this->controller?>[apelido]"  class="col-xs-12 col-sm-12 col-lg-12  apelido"  value="<?=$data[apelido]?>">
                </p>
              </div>
