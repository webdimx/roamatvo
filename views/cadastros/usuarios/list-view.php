...
<div class="btn-group btn-corner">
    <a href="<?=HOME_URI.$this->controller?>/adicionar-usuarios" class="btn btn-success btn-sm filterRegistry filterRegistry"><i class="fa fa-plus bigger-110 "></i> Novo</a>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
      <thead>
          ...
          <th rowspan="1" colspan="1">Situação<br>
			 <select name="situacao" class="filter">
				...
				<option value="3" <?=($_GET[situacao]==3?'checked':'')?>>Inativo</option>
			</select>  	  
		  </th>
          ...
          <th rowspan="1" colspan="1">Observação<br><input type="text" class="filter" name="observacao" value="<?=$_GET[observacao]?>"></th>
      ...
      <tbody>
          ...
          <tr role="row" class="odd">
			  ...
			  <td><?=$_item[email]?></td>
              <td><?=$_item[celular]?></td>
              <td><?=$_item[observacao]?></td>
             <td align="center"><a href="<?=HOME_URI.$this->controller."/editar-usuarios/".$_item[ID]?>"><button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button></a></td>
		  </tr>  
