            ...
            <div class="content">
              ...
              <div class="col-lg-12 ">
                <p>
                  ...
                  <input type="text"  name="<?=$this->controller?>[simcard]"  class="col-xs-12 col-sm-12 col-lg-12 required"  value="<?=$data[simcard]?>">
                </p>
              </div>
				<div class="col-lg-12 ">
               <p>
			 ...
			 <div class="col-lg-12">
                <p>
                  ...
                  <select  name="<?=$this->controller?>[local_estoque]"  class="col-xs-12 col-sm-12 col-lg-12 required">
					...
					?>
					<option value="<?=$option[ID]?>" <?=($option[ID]==$data[local_estoque]?'selected':'')?>><?=$option[local]?></option>
					<?
					 endforeach;  
					?>
				  </select>                 
