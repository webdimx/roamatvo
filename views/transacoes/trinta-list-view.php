...
$cfg = $this->getConfig();
$_attributes = $model->getList30($this->type);
?>
...
<div class="btn-group btn-corner">
    ...
    <a href="<?=HOME_URI.$this->controller?>/trinta-dias" class="btn btn-primary btn-sm  clear-filters"><i class="fa fa-ban bigger-110 "></i> Limpar filtros</a>
</div>
</div>
...
<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
      ...
      <tbody>
          ...
          ?>
          <tr role="row" class="odd <?=($_item[qty]==2?'red':'')?>">
			  <td align="center">
			 ...
			 <td><?=($_item[nota_d]?'A':($_item[emitir_nota]==1?'S':''))?></td>
