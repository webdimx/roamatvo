    ...
    <div class="widget-body">
        <div class="widget-main padding-20 scrollable " data-size="125" style="position: relative;">
            <div class="content">
			  ...
			  <div class="col-lg-12 ">
                <p>
				<label class="control-label no-padding-right" for="form-field-1">Local de Atuação:</label><br>
				<select name="<?=$this->controller?>[area_atuacao]"  class="col-xs-12 col-sm-12 col-lg-12">
				<option value=""></option>
