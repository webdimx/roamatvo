...
<div class="widget-box  ui-sortable-handle page-box" id="usuarios" style="opacity: 1;">
    <div class="widget-header widget-header-small">
        <h6 class="widget-title">Salas</h6>
    </div>
            ...
            <div class="row">
              <div class="col-xs-12">
              	 <div class="well fake-form">
                 	<div class="row">
                    	<div class="col-xs-12">
                    		<h4 class="blue smaller ">Adicione uma sala</h4>
                    	</div>
                    </div>
                    ...
                    <div class="row">
                    	<div class="col-xs-12">
                            ...
                            <button type="button" class="btn btn-sm btn-success action-add" data-action="add-room">Adicionar</button>
                        </div>
                    </div>
            ...
            <tbody>
             ...
             if($salas):
                ...
                <tr>
                  ...
                  <td rowspan="1" colspan="1">
                  	<a class="btn btn-xs btn-info edit-action" data-id="<?=$sala[ID]?>" data-status="edit" data-action="salas" >
                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                    </a>
                    <a class="btn btn-xs btn-danger delete-action"  data-id="<?=$sala[ID]?>"  data-action="salas">
