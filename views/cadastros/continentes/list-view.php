...
<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
	...
	<div class="dt-buttons btn-overlap btn-group">
		<div class="btn-group btn-corner">
			<a href="<?= HOME_URI . $this->controller ?>/adicionar-continente"
			...
			<a href="#modal-confirm" data-toggle="modal" data-table="wd_continentes"
	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid"
		...
		<tbody>
			...
			<?
			$_attributes = $model->getList('continentes');
			...
			foreach ($_attributes[data] as $_item):
				...
				<tr role="row" class="odd">
					...
					<td align="center"><a href="<?= HOME_URI . $this->controller . "/editar-continente/" . $_item[ID] ?>"><button
