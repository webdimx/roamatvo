...
<div class="btn-group btn-corner">
    ...
    <a href="<?=HOME_URI.$this->controller?>/prorrogados" class="btn btn-primary btn-sm  clear-filters"><i class="fa fa-ban bigger-110 "></i> Limpar filtros</a>
    
    <?
    if($this->controller=="relatorios"):
    ?>
    <a href="<?=HOME_URI.$this->controller?>/exportProrrogados?<?=str_replace('path=relatorios/prorrogados', '', $_SERVER['QUERY_STRING'])?>" class="btn btn-success btn-sm  clear-filters"><i class="fa fa-file-excel-o"></i> Exportar</a>
    <?
    endif;
    ?>
</div>
...
<div class="table-content mCustomScrollbar _mCS_1">
<table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
      <thead>
		...
		?>
		  ...
		  <th rowspan="1" colspan="1">Data OFF Adiado <br><input type="text" class="filter date date-range " data-date-format="dd/mm/yyyy"  name="data_off_adiado" value="<?=$_GET['data_off_adiado']?>"></th>
		  <th rowspan="1" colspan="1">Data Adiamento <br><input type="text" class="filter date date-range " data-date-format="dd/mm/yyyy"  name="data_adiamento" value="<?=$_GET['data_adiamento']?>"></th>
		  <th rowspan="1" colspan="1">Dias Adiados <br><input type="text" class="filter id " data-date-format="dd/mm/yyyy"  name="adiar" value="<?=$_GET['adiar']?>"></th>
      ...
      <tbody>
          ...
          <tr role="row" class="odd">
			  ...
			  <td>
			  <?=($_item[data_adiamento]?formatDate($_item[data_adiamento]):'')?>
