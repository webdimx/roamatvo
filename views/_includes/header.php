...
<div id="navbar" class="navbar navbar-default    navbar-collapse       h-navbar ace-save-state">
	<div class="navbar-container ace-save-state" id="navbar-container">
		...
		text-align: center;float:left ">Sistema de Gerenciamento RoamAtvo</div>
			...
			<button class="pull-right navbar-toggle" type="button" data-toggle="collapse" data-target="#sidebar"
				aria-expanded="true">
			...
			if ($_SESSION['userdata']['type'] == 2):
				...
				if ($this->sideMin):
					?>
					<button data-target="#sidebar2" data-toggle="collapse" type="button" class="pull-right navbar-toggle"
						aria-expanded="true">
						<span class="sr-only">Toggle sidebar</span>
			...
			<ul class="nav navbar-nav">
				...
				<li>
					<span class="input-icon input-icon-right">
						<input type="search" class="search filter" name="search"
							placeholder="Pesquise pelo Cliente, MDN ou SIMCARD">
